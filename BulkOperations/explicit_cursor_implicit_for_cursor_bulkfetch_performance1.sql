...
ALTER PROCEDURE test_ex_cr_impl_cr_for_cr_prf1
...
BEGIN
   ...
   dbms_output.put_line('----------------------------------------------------');
   dbms_output.put_line('----------------------------------------------------');
   test_ex_cr_impl_cr_for_cr_prf1 ('implicit cursor for loop', 10000, 10000000);
   dbms_output.put_line('----------------------------------------------------');
   test_ex_cr_impl_cr_for_cr_prf1 ('explicit open, fetch, close', 10000, 10000000);
   dbms_output.put_line('----------------------------------------------------');
   test_ex_cr_impl_cr_for_cr_prf1 ('bulk fetch', 10000, 10000000);
   dbms_output.put_line('----------------------------------------------------');
END;
/
