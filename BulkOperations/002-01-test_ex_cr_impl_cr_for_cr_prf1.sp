CREATE OR REPLACE PROCEDURE SAIMK.test_ex_cr_impl_cr_for_cr_prf1 (approach IN VARCHAR2, p_bulk_fetch_limit NUMBER, p_max_num_rows_to_select NUMBER DEFAULT 100)
IS
   L_T1 TIMESTAMP;
   L_T2 TIMESTAMP;
   --
   CURSOR cur IS
      SELECT * FROM all_source WHERE ROWNUM < p_max_num_rows_to_select;
   --   
   one_row cur%ROWTYPE;
   --
...
END test_ex_cr_impl_cr_for_cr_prf1;
/
