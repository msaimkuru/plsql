 ...
 * ------------------------------------------------------
 * Before taking this tutorial, you should be proficient with the basics of SQL 
 * and PL/SQL programming. For example, you know how to create procedures and 
 * functions. You know how to write DML statements. 
 * 
