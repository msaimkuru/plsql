 ...
 * values in the bind arrays that will be used to generate DML statements in the 
 * FORALL. Sound complicated? It is, sort of. It is another level of 
 * "indirectness" from INDICES OF, and not as commonly used.
 *
 ...
 * elements in turn have the values 124, 123 and 129. You should therefore see 
